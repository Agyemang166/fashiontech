...
const AgyemangDevSobolo = () => {
  ...
  const filteredProducts = productList.filter(product => 
    product.subcategories && product.subcategories.includes("AgyemangDev Sobolo")
  );
  ...
  return (
    <div className="container mx-auto pb-5 p-2">
      ...
      {filteredProducts.length > 0 ? (
        ...
        <p>No products available in the "AgyemangDev Sobolo" subcategory.</p>
      )}
    </div>
  );
};

export default AgyemangDevSobolo;
