...
const JelwelryAccessories = () => {
  ...
  const filteredProducts = productList.filter(product => 
    product.subcategories && product.subcategories.includes("Jewelry & Accessories")
  );
  ...
  return (
    <div className="container mx-auto pb-5 p-2">
      ...
      {filteredProducts.length > 0 ? (
        ...
        <p>No products available in the "Jewelry & Accessories" subcategory.</p>
      )}
    </div>
  );
};

export default JelwelryAccessories;
